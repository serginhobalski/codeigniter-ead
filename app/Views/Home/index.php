...
<body>
      ...
      <div class="row">
        <div class="col-lg-8 col-sm-8">
          <div class="left-content">
            <p>Plataforma <em>Estimular Digital</em></p>
          </div>
        </div>
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="curso-detalhe.php"><img src="assets/images/meeting-01.jpg" alt="New Lecturer Meeting"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="curso-detalhe.php"><h4>Higher Education Conference</h4></a>
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="curso-detalhe.php"><h4>Student Training Meetup</h4></a>
                  <p>Morbi in libero blandit lectus<br>cursus ullamcorper.</p>
                </div>
              </div>
            </div>
  ...
  <section class="contact-us" id="contact">
        ...
        <div class="col-lg-3">
          <div class="right-info">
            <ul>
              <li>
                <h6>Telefone</h6>
                <span>(91) 99188-2198</span>
              </li>
              <li>
                <h6>E-mail</h6>
                <span>contato@estimulardigital.com</span>
              </li>
              <li>
                <h6>Endereço</h6>
                <span>Belém - PA, 66083-340, Brazil</span>
              </li>
              <li>
                <h6>Website</h6>
                <span>www.estimulardigital.com</span>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="footer">
      <p>© <?php echo date('Y'); ?> Estimular Digital. 
          <br>
